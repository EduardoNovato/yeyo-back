...
class CompraProveedorBase(BaseModel):
    ...
    fecha_compra: Optional[datetime] = Field(None, description="Fecha de la compra")
    fecha_recibido: Optional[datetime] = Field(None, description="Fecha cuando se recibió la compra")
...
class CompraProveedorUpdate(BaseModel):
    ...
    valor_compra: Optional[Decimal] = Field(None, description="Valor de la compra")
    factura: Optional[str] = Field(None, description="Número de factura")
    fecha_compra: Optional[datetime] = Field(None, description="Fecha de la compra")
    fecha_recibido: Optional[datetime] = Field(None, description="Fecha cuando se recibió la compra")
    destino: Optional[str] = Field(None, description="Destino de la compra")
    estado: Optional[int] = Field(None, description="Estado de la compra")
